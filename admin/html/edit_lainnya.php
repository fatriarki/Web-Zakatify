...
$mustahiklainnya = query("SELECT * FROM mustahik_lainnya WHERE id_mustahiklainnya = $id_mustahiklainnya")[0];
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <form action="" method="POST">
                                                <input type="hidden" name="id_mustahiklainnya" value="<?= $mustahiklainnya["id_mustahiklainnya"]; ?>">
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label" for="nama">Nama Penerima</label>
                                                    <div class="col-sm-10">
                                                        <div class="input-group input-group-merge">
                                                            <input type="text" name="nama" class="form-control" id="nama" placeholder="Masukkan nama" value="<?= $mustahiklainnya["nama"]; ?>" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
