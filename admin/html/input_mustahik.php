            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="data_mustahik.php">Data Mustahik</a> /</span> Input Kategori Mustahik</h4>
                            ...
                            <div class="col-xxl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0">Input Data Mustahik</h5>
                                    </div>
                                    <div class="card-body">
                                        <form action="" method="POST">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-select" id="kategori" name="nama_kategori" aria-label="Default select example">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <input type="text" name="jumlah_hak" id="jumlah_hak" class="form-control phone-mask" placeholder="Jumlah hak" required />
                                                    </div>
                                                </div>
                                            </div>
