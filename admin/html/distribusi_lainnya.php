...
$mustahiklainnya = query("SELECT * FROM mustahik_lainnya");
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">Distribusi Zakat Fitrah /</span> Data Distribusi Lainnya</h4>
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php $i = 1; ?>
                                        <?php foreach ($mustahiklainnya as $row) : ?>
                                            <tr>
                                                <td><?= $i; ?></td>
                                                <td></i> <strong><?= $row["nama"]; ?></strong></td>
                                                <td><?= $row["kategori"]; ?></td>
                                                <td><?= $row["hak"]; ?> kg</td>
                                                <td>
                                                    <div class="btn">
                                                        <a href="edit_lainnya.php?id_mustahiklainnya=<?= $row["id_mustahiklainnya"]; ?>"><i class="bx bx-edit-alt me-1"></i></a> <span>⠀</span>
                                                        <a href="hapus_lainnya.php?id_mustahiklainnya=<?= $row["id_mustahiklainnya"]; ?>"><i class="bx bx-trash me-1"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                        ...
                        <!--/ Basic Bootstrap Table -->
                        <a href="input_lainnya.php" class="card-header"><button style="margin-top:20px; margin-left: 1035px;" type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i>
