            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">Zakatify</span>
                    </a>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="">Distribusi Lainnya</a> /</span> Input Distribusi</h4>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <input type="text" name="nama" class="form-control" id="nama" placeholder="Masukkan nama" value="<?= $id_mzk["nama"]; ?>" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                        ...
                                        <script>
                                            function autofillJumlahHak() {
                                                ...
                                                } else if (kategori === "Amil") {
                                                    jumlahHak.value = "10 kg";
                                                } else if (kategori === "Fisabilillah") {
                                                    jumlahHak.value = "3 kg";
                                                } else if (kategori === "Muallaf") {
                                                    jumlahHak.value = "3 kg";
                                                } else if (kategori === "IbnuSabil") {
                                                    jumlahHak.value = "3 kg";
                                                } else {
                                                    jumlahHak.value = "";
                                                }
