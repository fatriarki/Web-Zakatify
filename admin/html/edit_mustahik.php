...
$id_mustahik = query("SELECT * FROM kategori_mustahik WHERE id_kategori = $id_kategori")[0];

if (isset($_POST['submit'])) {

    // cek data berhasil diedit atau tidak
    if (edit_mustahik($_POST) > 0) {
        echo "
    <script>
    ...
    <script>
      ...
      document.location.href = 'edit_mustahik.php';
    </script>
    ";
    }
}
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="data_mustahik.php">Data Mustahik</a> /</span> Edit Data Mustahik</h4>
                            ...
                            <div class="col-xxl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0">Edit Data Mustahik</h5>
                                    </div>
                                    <div class="card-body">
                                        <form action="" method="POST">
                                            <input type="hidden" name="id_kategori" value="<?= $id_mustahik["id_kategori"]; ?>">
                                            <div class="row mb-3">
                                                <label class="col-sm-2 form-label" for="kategori">Kategori</label>
                                                <div class="col-sm-10">
                                                    <select class="form-select" id="nama_kategori" name="nama_kategori" aria-label=" Default select example">
                                            ...
                                            <div class="row mb-3">
                                                <label class="col-sm-2 form-label" for="jumlah_hak">Jumlah Hak</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <input type="number" name="jumlah_hak" id="jumlah_hak" class="form-control phone-mask" required value="<?= $id_mustahik["jumlah_hak"]; ?>" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2" />
                                                    </div>
                                                </div>
                                            </div>
