...
if (isset($_POST['submit'])) {
    ...
    if (tambah_mustahiklainnya($_POST) > 0) {
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="distribusi_warga.php">Distribusi Lainnya</a> /</span> Input Distribusi Warga</h4>
