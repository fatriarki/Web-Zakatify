            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="data_muzakki.php">Data Pengumpulan</a> /</span> Bayar Zakat </h4>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="" method="POST">
                                            <input type="hidden" name="id_zakat" value="<?= $id_mzk["id_muzakki"]; ?>">
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label" for="nama">Nama</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-user"></i></span>
                                                        <input type="text" name="nama_KK" class="form-control" id="nama" placeholder="Masukkan nama" required value="<?= $id_mzk["nama"]; ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="number" name="jumlah_tanggungan" id="jumlah_tanggungan" class="form-control" placeholder="Masukkan Jumlah Tanggungan" required value="<?= $id_mzk["jumlah_tanggungan"]; ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-2 form-label" for="jumlah_bayar">Jumlah Bayar</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <span id="basic-icon-default-phone2" class="input-group-text"><i class="bx bx-phone"></i></span>
                                                        <input type="number" name="jumlah_tanggunganyangdibayar" id="jumlah_bayar" class="form-control phone-mask" placeholder="Masukkan jumlah tanggungan" required value="<?= $id_mzk["jumlah_tanggungan"]; ?>" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-2 form-label" for="jenis_bayar">Jenis Fitrah</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
