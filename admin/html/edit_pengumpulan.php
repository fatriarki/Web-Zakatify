...
$id_pengumpulan = query("SELECT * FROM bayarzakat WHERE id_zakat = $id_zakat")[0];

if (isset($_POST['submit'])) {

    // cek data berhasil diedit atau tidak
    if (edit_pengumpulan($_POST) > 0) {
        echo "
    <script>
    ...
    <script>
      ...
      document.location.href = 'edit_pengumpulan.php';
    </script>
    ";
    }
}
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="data_pengumpulan.php">Data Pengumpulan</a> /</span> Edit Data Pengumpulan</h4>
                            ...
                            <div class="col-xxl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0">Edit Data Pengumpulan</h5>
                                    </div>
                                    <div class="card-body">
                                        <form action="" method="POST">
                                            <input type="hidden" name="id_zakat" value="<?= $id_pengumpulan["id_zakat"]; ?>">
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label" for="nama">Nama</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-user"></i></span>
                                                        <input type="text" name="nama_KK" class="form-control" id="nama_KK" placeholder="Masukkan nama" required value="<?= $id_pengumpulan["nama_KK"]; ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-user"></i></span>
                                                        <input type="text" name="jumlah_tanggungan" class="form-control" id="jumlah_tanggungan" placeholder="Masukkan jumlah tanggungan" required value="<?= $id_pengumpulan["jumlah_tanggungan"]; ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-2 form-label" for="kategori">Jenis Bayar</label>
                                                <div class="col-sm-10">
                                                    <select class="form-select" id="jenis_bayar" name="jenis_bayar" aria-label=" Default select example">
                                            ...
                                            <div class="row mb-3">
                                                <label class="col-sm-2 form-label" for="jumlah_tanggunganyangdibayar">Jumlah Tanggungan yang Dibayar</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <span id="basic-icon-default-phone2" class="input-group-text"><i class="bx bx-phone"></i></span>
                                                        <input type="number" name="jumlah_tanggunganyangdibayar" id="jumlah_tanggunganyangdibayar" class="form-control phone-mask" required value="<?= $id_pengumpulan["jumlah_tanggunganyangdibayar"]; ?>" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2" />
                                                    </div>
                                                </div>
                                            </div>
