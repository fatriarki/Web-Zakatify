            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">Muzakki /</span> Data Muzakki</h4>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <?php foreach ($muzakki as $row) : ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><?= $row["jumlah_tanggungan"]; ?></td>
                                                <td style="text-align: center;"><?= $row["keterangan"]; ?></td>
                                                <td style="text-align: center;">
                                                    <div class="btn">
                                                        <a href="edit_muzakki.php?id_muzakki=<?= $row["id_muzakki"]; ?>"><i class="bx bx-edit-alt me-1"></i></a>
                                                        <a href="hapus.php?id_muzakki=<?= $row["id_muzakki"]; ?>"><i class="bx bx-trash me-1"></i></a> <span>|</span><span>⠀</span>
                                                        <a href="bayar.php?id_muzakki=<?= $row["id_muzakki"]; ?>">Bayar <span>⠀</span></a> <span>|</span><span>⠀</span>
                                                        <a href="input_distribusi_muzakki.php?id_muzakki=<?= $row["id_muzakki"]; ?>">Distribusi</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                        ...
                        <!--/ Basic Bootstrap Table -->
                        <a href="input_muzakki.php" class="card-header"><button style="margin-top:20px; margin-left: 1035px;" type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i>
